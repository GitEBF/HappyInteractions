...
<form method='post' class="hide-submit d-flex justify-content-center iconContainer align-items-center"
    ...
    <label>
        ...
        <svg class="btn emotionIcon happyIcon" id="happyIcon" xmlns="http://www.w3.org/2000/svg" height="13em"
            viewBox="0 0 512 512" style="fill:#7FC84C">
            <path id="happyIcon"
    ...
    <label>
        ...
        <svg class="btn emotionIcon midIcon" id="midIcon" style="fill:#F8C65E" xmlns="http://www.w3.org/2000/svg"
            height="13em" viewBox="0 0 512 512">
            <path id="midIcon"
    ...
    <label>
        ...
        <svg class="btn emotionIcon sadIcon" id="sadIcon" style="fill:#EA5143" xmlns="http://www.w3.org/2000/svg"
            height="13em" viewBox="0 0 512 512">
            <path id="sadIcon"
